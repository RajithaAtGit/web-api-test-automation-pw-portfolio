...
import { TestDataBuilder, UserData, ProductData, OrderData } from '../TestDataBuilder';
import { TestEntity, TestDataContext } from '../TestFixtures';
...
const createMockTestDataContext = (): TestDataContext => {
  return {
    testId: 'test-123',
    createdEntities: [],
  };
...
describe('TestDataBuilder', () => {
  let mockRequest: jest.Mocked<APIRequestContext>;
  let mockTestData: TestDataContext;
  let testDataBuilder: TestDataBuilder;

  beforeEach(() => {
    mockRequest = createMockAPIRequestContext();
    mockTestData = createMockTestDataContext();
    testDataBuilder = new TestDataBuilder(mockRequest, mockTestData);
  ...
  describe('createUser', () => {
    ...
    it('should create a user with custom data', async () => {
      ...
      const customData: Partial<UserData> = {
        username: 'customuser',
  ...
  describe('createProduct', () => {
    ...
    it('should create a product with custom data', async () => {
      ...
      const customData: Partial<ProductData> = {
        name: 'Custom Product',
        price: 199.99,
  ...
  describe('createOrder', () => {
    ...
    it('should create an order with custom data', async () => {
      ...
      const userId = 'user-123';
      const productIds = ['product-123'];
      const customData: Partial<OrderData> = {
  ...
  describe('initialize', () => {
    ...
    it('should register a factory that creates a user', async () => {
      ...
      // Call the factory
      const customData: Partial<UserData> = { username: 'customuser' };
    ...
    it('should register a factory that creates a product', async () => {
      ...
      // Call the factory
      const customData: Partial<ProductData> = { name: 'Custom Product' };

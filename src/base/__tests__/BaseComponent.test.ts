...
class TestComponent extends BaseComponent {
  ...
  public getChildLocatorTest(selector: string): Locator {
    return this.getChildLocator(selector);
  }

  public async clickChildTest(selector: string, options?: { timeout?: number; force?: boolean; position?: { x: number; y: number } }): Promise<void> {
    return this.clickChild(selector, options);
  }

  public async getChildTextTest(selector: string): Promise<string> {
    return this.getChildText(selector);
  }

  public async fillChildTest(selector: string, value: string, options?: { timeout?: number }): Promise<void> {
    return this.fillChild(selector, value, options);
  }

  public async isChildVisibleTest(selector: string, options?: { timeout?: number }): Promise<boolean> {

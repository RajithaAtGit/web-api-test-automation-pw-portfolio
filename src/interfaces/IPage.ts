...
export interface IPage {
   ...
   */
  navigate(options?: { timeout?: number; waitUntil?: 'load' | 'domcontentloaded' | 'networkidle' }): Promise<void>;
   ...
   */
  waitForPageLoad(options?: { timeout?: number; waitUntil?: 'load' | 'domcontentloaded' | 'networkidle' }): Promise<void>;
   ...
   */
  waitForCondition(condition: () => Promise<boolean> | boolean, options?: { timeout?: number; polling?: number }): Promise<void>;
}

import { test, expect, TestHelper } from '@/utils/TestFixtures';
import { TestDataBuilder } from '@/utils/TestDataBuilder';

test.describe('User Registration', () => {
  test('should register a new user successfully', async ({ registerPage, page, browser }) => {
    // Create custom user data using TestDataBuilder
    const userData = TestDataBuilder.createDefaultUser();
    ...
    await TestHelper.registerUser(registerPage, userData);

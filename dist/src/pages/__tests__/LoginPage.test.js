...
describe('LoginPage', () => {
    ...
    beforeEach(() => {
        ...
        loginPage = new LoginPage_1.LoginPage(mockPage);
        // Reset all mocks
        jest.clearAllMocks();
    });
    describe('login', () => {
    ...
    describe('fillLoginForm', () => {
        it('should fill the username and password fields', async () => {
            // Mock methods
            jest.spyOn(loginPage, 'waitForSelector').mockResolvedValue(undefined);
            jest.spyOn(loginPage, 'fillField').mockResolvedValue(undefined);
        ...
        it('should check the rememberMe checkbox if rememberMe is true', async () => {
            ...
            jest.spyOn(loginPage, 'waitForSelector').mockResolvedValue(undefined);
            jest.spyOn(loginPage, 'fillField').mockResolvedValue(undefined);
            jest.spyOn(loginPage, 'clickElement').mockResolvedValue(undefined);
    ...
    describe('getErrorMessage', () => {
        it('should return the error message if visible', async () => {
            // Mock methods
            jest.spyOn(loginPage, 'isElementVisible').mockResolvedValue(true);
            jest.spyOn(loginPage, 'getElementText').mockResolvedValue('Invalid credentials');
        ...
        it('should return null if error message is not visible', async () => {
            // Mock methods
            jest.spyOn(loginPage, 'isElementVisible').mockResolvedValue(false);
            const errorMessage = await loginPage.getErrorMessage();
    ...
    describe('isPageReady', () => {
        ...
        it('should return false if any required element is not visible', async () => {
            // Mock methods
            jest.spyOn(loginPage, 'isElementVisible').mockImplementation((selector) => {

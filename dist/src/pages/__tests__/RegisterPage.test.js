...
describe('RegisterPage', () => {
    ...
    beforeEach(() => {
        ...
        registerPage = new RegisterPage_1.RegisterPage(mockPage);
    });
    ...
    describe('fillRegistrationForm', () => {
        it('should fill all fields in the registration form', async () => {
            await registerPage.fillRegistrationForm('John', 'Doe', '123 Test Street', 'Testville', 'TX', '75001', '1234567890', '123-45-6789', 'john.doe.test', 'Test@1234', 'Test@1234');
    ...
    describe('register', () => {
        it('should fill the form, submit it, and wait for success', async () => {
            await registerPage.register('John', 'Doe', '123 Test Street', 'Testville', 'TX', '75001', '1234567890', '123-45-6789', 'john.doe.test', 'Test@1234', 'Test@1234');

...
class TestPage extends BasePage_1.BasePage {
    ...
    async onPageLoadedTest() {
        return this.onPageLoaded();
    }
    async waitForSelectorTest(selector, options) {
        return this.waitForSelector(selector, options);
    }
    async clickElementTest(selector, options) {
        return this.clickElement(selector, options);
    }
    async fillFieldTest(selector, value, options) {
        return this.fillField(selector, value, options);
    }
    async selectOptionTest(selector, value) {
        return this.selectOption(selector, value);
    }
    async isElementVisibleTest(selector, options) {
        return this.isElementVisible(selector, options);
    }
    async getElementTextTest(selector) {
        return this.getElementText(selector);
    }
    async getElementAttributeTest(selector, attribute) {
        return this.getElementAttribute(selector, attribute);
    }
    async hoverElementTest(selector, options) {
        return this.hoverElement(selector, options);
    }
    async pressKeyTest(key) {
        return this.pressKey(key);
    }
    async typeTextTest(text) {
...
describe('BasePage', () => {
    ...
    describe('navigate', () => {
        ...
        it('should pass navigation options to goto', async () => {
            const options = { timeout: 5000, waitUntil: 'load' };
